...
namespace AerovelenceMod
{
    public class AerovelenceMod : Mod
    {
		...
		public override void Load()
		{
			...
			Ref<Effect> screenRef = new Ref<Effect>(GetEffect("Effects/CavernCrystalShine"));
			Filters.Scene["CavernCrystalShine"] = new Filter(new ScreenShaderData(screenRef, "CavernCrystalShine"), EffectPriority.High);
			Filters.Scene["CavernCrystalShine"].Load();
