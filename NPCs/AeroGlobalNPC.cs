	...
	public class AeroGlobalNPC : GlobalNPC
	{
		...
		public override void DrawEffects(NPC npc, ref Color drawColor)
		{
			if (SoulFire)
			{
				...
				{
					int dust = Dust.NewDust(npc.position - new Vector2(2f, 2f), npc.width + 4, npc.height + 4, DustType<WispDust>(), npc.velocity.X * 0.4f, npc.velocity.Y * 0.4f, 100, default, 3.5f);
