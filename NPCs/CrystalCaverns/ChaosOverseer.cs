...
namespace AerovelenceMod.NPCs.CrystalCaverns
{
    public class ChaosOverseer : ModNPC
    {
        ...
        {
            Texture2D texture = mod.GetTexture("NPCs/CrystalCaverns/ChaosOverseer_Glow");
        ...
        public override void HitEffect(int hitDirection, double damage)
        {
            if (npc.life <= 0)
            {
                ...
                Gore.NewGore(npc.position, npc.velocity, mod.GetGoreSlot("Gores/ChaosOverseerGore1"), 1f);
                Gore.NewGore(npc.position, npc.velocity, mod.GetGoreSlot("Gores/ChaosOverseerGore2"), 1f);
                Gore.NewGore(npc.position, npc.velocity, mod.GetGoreSlot("Gores/ChaosOverseerGore3"), 1f);
            }
        }
        ...
        {
            return spawnInfo.player.GetModPlayer<AeroPlayer>().ZoneCrystalCaverns && Main.hardMode ? .05f : 0f;
        }
    }
}