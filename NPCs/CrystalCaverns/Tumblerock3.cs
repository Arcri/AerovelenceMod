    ...
    public class Tumblerock3 : ModNPC
    {
        ...
        public override void HitEffect(int hitDirection, double damage)
        {
            if (npc.life <= 0)
            {
                ...
                Gore.NewGore(npc.position, npc.velocity, mod.GetGoreSlot("Gores/TumbleRockV3Gore1"), 1f);
                Gore.NewGore(npc.position, npc.velocity, mod.GetGoreSlot("Gores/TumbleRockV3Gore2"), 1f);
                Gore.NewGore(npc.position, npc.velocity, mod.GetGoreSlot("Gores/TumbleRockV3Gore3"), 1f);
            }
        }
