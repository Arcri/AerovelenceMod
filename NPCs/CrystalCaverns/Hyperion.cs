...
namespace AerovelenceMod.NPCs.CrystalCaverns
{
    public class Hyperion : ModNPC
    {
        ...
        {
            Texture2D texture = mod.GetTexture("NPCs/CrystalCaverns/Hyperion_Glow");
        ...
        {
            return spawnInfo.player.GetModPlayer<AeroPlayer>().ZoneCrystalCaverns && !Main.dayTime && Main.hardMode ? .2f : 0f;
        }
