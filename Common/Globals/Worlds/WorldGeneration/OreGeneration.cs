...
namespace AerovelenceMod.Common.Globals.Worlds.WorldGeneration
{
    public class OreGeneration : ModWorld
    {
        ...
        {
            progress.Message = "Burnshock Ore";
            ...
            for (int i = 0; i < oreAmount; i++)
            {
                ...
                WorldGen.OreRunner(x, y, WorldGen.genRand.Next(3, 6), WorldGen.genRand.Next(3, 6),
                    (ushort)ModContent.TileType<BurnshockOreBlock>());
            }

            progress.Message = "Phantic Ore";
            ...
            for (int i = 0; i < oreAmount; i++)
            {
                ...
                WorldGen.OreRunner(x, y, WorldGen.genRand.Next(3, 6), WorldGen.genRand.Next(3, 6),
                    (ushort)ModContent.TileType<PhanticOreBlock>());
            }
        }
    }
}
