...
namespace AerovelenceMod.Content.Items.Tools.Drills
{
    ...
    {
        public override string Texture => "AerovelenceMod/Content/Items/Tools/Drills/StardustDrillProj";
        ...
        {
            _colorGlowTexture = Mod.Assets.Request<Texture2D>("Content/Items/Tools/Drills/StardustDrillProjGlow").Value;
            _pulseGlowTexture = Mod.Assets.Request<Texture2D>("Content/Items/Tools/Drills/StardustDrillDrillOrange").Value;
            _drillTexture = Mod.Assets.Request<Texture2D>("Content/Items/Tools/Drills/StardustDrillDrill").Value;
