...
{
    public class AdamantiteDrill : GlobalItem
    {
        public override void SetDefaults(Item item)
        {
            if (item.type == ItemID.AdamantiteDrill)
            {
                ...
                item.value = Item.sellPrice(0, 2, 16, 0);
                item.useStyle = ItemUseStyleID.Shoot;
                item.DamageType = DamageClass.Melee;
                item.shoot = ModContent.ProjectileType<AdamantiteDrillProj>();
        ...
        public override bool CanUseItem(Item item, Player player)
        {
            if (item.type == ItemID.AdamantiteDrill)
            {
                return player.ownedProjectileCounts[ModContent.ProjectileType<AdamantiteDrillProj>()] == 0;
            }
    ...
    public class AdamantiteDrillProj : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Main.GameUpdateCount % 3 == 0)
            {
                ...
                Dust gd = Dust.NewDustPerfect(tipPosition, ModContent.DustType<GlowPixelCross>(), dustVel, 0, Color.Red, Main.rand.NextFloat(0.2f, 0.4f));
