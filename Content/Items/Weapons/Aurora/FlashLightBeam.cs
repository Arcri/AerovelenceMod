...
{
	public class FlashLightBeam : ModProjectile
	{
		...
		public override bool PreDraw(ref Color lightColor) 
		{
			...
			*/
			...
			//CandyCane Laser
			// Trail3 and Trail3, Red * 0.42, width of 10
			//Good laser Extra 196, lihgtning3

			myEffect.Parameters["uColor"].SetValue(Color.Red.ToVector3() * 0.42f);
			...
			float height = (20 * Projectile.scale); //25
			...
			var target2 = new Rectangle((int)pos.X, (int)pos.Y, width, (int)(height * 2.8f));
			var target3 = new Rectangle((int)pos.X, (int)pos.Y, width, (int)(height * 1.8f));

			Main.spriteBatch.Draw(texture, target2, null, Color.Red * 0.5f, LaserRotation, origin2, 0, 0);
			Main.spriteBatch.Draw(texture, target3, null, Color.Red * 0.5f, LaserRotation, origin2, 0, 0);
