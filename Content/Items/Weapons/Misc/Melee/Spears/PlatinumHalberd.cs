...
namespace AerovelenceMod.Content.Items.Weapons.Misc.Melee.Spears
{
    public class PlatinumHalberd : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<PlatinumHalberdStabProjectile>();
        }
        ...
        public override bool CanUseItem(Player player)
        {
            ...
            {
                if (player.ownedProjectileCounts[ModContent.ProjectileType<PlatinumHalberdStabProjectile>()] > 0)
                    return false;
                Item.useTime = 28;
            ...
            {
                if (player.ownedProjectileCounts[ModContent.ProjectileType<PlatinumHalberdSwingProjectile>()] > 0)
                    return false;
                Item.useTime = 45;
                Item.useAnimation = 45;
                Item.shootSpeed = 1f;
                Item.shoot = ModContent.ProjectileType<PlatinumHalberdSwingProjectile>();
            }
        ...
        public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            ...
            {
                bool alternateSwing = player.GetModPlayer<PlatinumHalberdPlayer>().alternateSwing;
                int proj = Projectile.NewProjectile(source, position, velocity, type, damage, knockback, player.whoAmI, alternateSwing ? 1 : 0);
                player.GetModPlayer<PlatinumHalberdPlayer>().alternateSwing = !player.GetModPlayer<PlatinumHalberdPlayer>().alternateSwing;
            }
            return false;
        }
    ...
    public class PlatinumHalberdPlayer : ModPlayer { public bool alternateSwing = false; }

    public class PlatinumHalberdSwingProjectile : BaseSwingSwordProj
    {
        public override string Texture => "AerovelenceMod/Content/Items/Weapons/Misc/Melee/Spears/PlatinumHalberdProjectileSwing";
    ...
    public class PlatinumHalberdStabProjectile : ModProjectile
    {
        public override string Texture => "AerovelenceMod/Content/Items/Weapons/Misc/Melee/Spears/PlatinumHalberdProjectileStab";
