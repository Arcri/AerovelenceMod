...
//namespace AerovelenceMod.Content.Items.Weapons.Misc.Ranged.Guns.Fibber
//{
...
//        private int inactiveTimeout = 90;
...
//                int bulletType = ModContent.ProjectileType<FibberBulletAlt>();
...
//        {
//            Texture2D texture = ModContent.Request<Texture2D>("AerovelenceMod/Content/Items/Weapons/Misc/Ranged/Guns/Fibber/RedundantFibber").Value;
...
//    public class FibberBulletAlt : ModProjectile
//    {
//        public override string Texture => "Terraria/Images/Projectile_0";
//        public static int CurrentAmmoType = AmmoID.Bullet;
//        public int fakeDisplayDamage = 0;
...
//            {
//                DrawShit(giveUp: false);
//            });
//            DrawShit(giveUp: true);
...
//            Color[] cols = { Color.DodgerBlue * 0.75f, Color.Blue * 0.525f, Color.Blue * 0.375f };
