...
namespace AerovelenceMod.Content.Items.Weapons.Misc.Magic.FlashLight
{
    public class TheFlashlightProj : ModProjectile
    {
                    ...
                    if (timer % 2 == 0)
                    {
                        ...
                        if (Main.rand.NextBool())
                        {
                            for (int i = 0; i < 2; i++)
                            {
                                ...
                                Dust gd = GlowDustHelper.DrawGlowDustPerfect(npc.Center, ModContent.DustType<LineGlow>(), randomStart * Main.rand.NextFloat(0.65f, 1.35f), Color.Goldenrod, 0.15f, 0.2f, 0f, dustShader2);
                        ...
                        else
                        {
                            for (int i = 0; i < 2; i++)
                            {
                                ...
                                Dust gd = GlowDustHelper.DrawGlowDustPerfect(npc.Center, ModContent.DustType<GlowCircleDust>(), randomStart * Main.rand.NextFloat(0.65f, 1.35f), Color.Goldenrod, 0.3f, 0.1f, 0f, dustShader2);
                                gd.fadeIn = 2;
                            }
                        }
                    }
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            myEffect.Parameters["uColor"].SetValue(Color.DarkGoldenrod.ToVector3() * 0.1f);
            ...
            float height = (laserWidth * 1.3f); //25
            ...
            myEffect2.Parameters["uColor"].SetValue(Color.Orange.ToVector3() * 1.5f);
            ...
            Main.spriteBatch.Draw(flare12, Projectile.Center + (direction.SafeNormalize(Vector2.UnitX) * 25) - Main.screenPosition, flare12.Frame(1,1,0,0), Color.Goldenrod, timer * 0.05f, flare12.Size() / 2, 0.2f * laserWidth * 0.02f, spriteEffects, 0.0f);
