...
{
	internal class LeadHook : ModItem
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Lead Hook");
		}
		...
		public override void SetDefaults()
		{
			...
			*/
			...
			item.shootSpeed = 18f;
			item.shoot = ModContent.ProjectileType<LeadHookProjectile>();
		}
	...
	internal class LeadHookProjectile : ModProjectile
	{
		public override void SetStaticDefaults()
		{
		...
		{
			Texture2D texture = ModContent.GetTexture("AerovelenceMod/AerovelenceMod/Items/Equipment/LeadHookChain");
