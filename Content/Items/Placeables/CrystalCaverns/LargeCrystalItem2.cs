...
{
    public class LargeCrystalItem2 : ModItem
    {
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("LargeCrystalItem2");
		}
        ...
        public override void SetDefaults()
        {
            ...
            item.createTile = mod.TileType("LargeCrystal2");
        }
        ...
        public override void AddRecipes()
        {
            ...
            modRecipe.AddIngredient(ModContent.ItemType<CavernCrystal>());
