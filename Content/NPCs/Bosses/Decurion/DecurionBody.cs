...
{
    [AutoloadBossHead]
    public class DecurionBody : ModNPC
    {
        ...
        {
        Texture2D texture = (Texture2D)ModContent.Request<Texture2D>("AerovelenceMod/Content/NPCs/Bosses/Decurion/DecurionBody_Glow");
