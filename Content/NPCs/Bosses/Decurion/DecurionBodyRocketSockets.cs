...
{
    [AutoloadBossHead]
    public class DecurionBodyRocketSockets : ModNPC
    {
        ...
        {
        Texture2D texture = (Texture2D)ModContent.Request<Texture2D>("AerovelenceMod/Content/NPCs/Bosses/Decurion/DecurionBodyRocketSockets_Glow");
