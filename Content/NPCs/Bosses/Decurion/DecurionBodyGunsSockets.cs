...
namespace AerovelenceMod.Content.NPCs.Bosses.Decurion
{
    ...
    public class DecurionBodyGunsSockets : ModNPC
    {
        ...
        {
            Texture2D texture = (Texture2D)ModContent.Request<Texture2D>("AerovelenceMod/Content/NPCs/Bosses/Decurion/DecurionBodyGunsSockets_Glow");
        ...
        public override bool PreAI()
        {
            ...
            NPC.chaseable = !NPC.AnyNPCs(Mod.Find<ModNPC>("DecurionBodyGun1").Type);
            NPC.chaseable = !NPC.AnyNPCs(Mod.Find<ModNPC>("DecurionBodyGun2").Type);
            if (NPC.ai[1] == 0)
            {
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
        {
            ...
            while (((num4 > 0 && num7 < num3) || (num4 < 0 && num7 > num3)) && Lighting.NotRetro)
            {
                ...
                Main.EntitySpriteDraw(texture2D, vector2 + NPC.Size / 2f - Main.screenPosition + new Vector2(0f, NPC.gfxOffY), new Rectangle?(rectangle), color2, rotation + NPC.rotation * num6 * (num7 - 1) * -spriteEffects.HasFlag(SpriteEffects.FlipHorizontally).ToDirectionInt(), vector, NPC.scale, spriteEffects, 0);
                num7 += num4;
            }
