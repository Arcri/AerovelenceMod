...
namespace AerovelenceMod.Content.NPCs.Bosses.Cyvercry
{
    public class CyverBot : ModNPC
    {
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color drawColor)
        {
            ...
            Texture2D texture = ModContent.GetTexture("AerovelenceMod/Content/NPCs/Bosses/Cyvercry/CyverBotRed");
        ...
        {
            Texture2D texture = ModContent.GetTexture("AerovelenceMod/Content/NPCs/Bosses/Cyvercry/GlowmaskBot");
