...
{
	internal class MinorCrystalSerpentHead : MinorCrystalSerpent
	{
	...
	internal class MinorCrystalSerpentBody : MinorCrystalSerpent
	{
	...
	internal class MinorCrystalSerpentTail : MinorCrystalSerpent
	{
	...
	public abstract class MinorCrystalSerpent : Worm
	{
		...
		public override void Init()
		{
			minLength = 6;
			maxLength = 6;
			tailType = NPCType<MinorCrystalSerpentTail>();
			bodyType = NPCType<MinorCrystalSerpentBody>();
			headType = NPCType<MinorCrystalSerpentHead>();
			speed = 5.5f;
			turnSpeed = 0.045f;
		}
	}

	public abstract class MinorSerpentWorm : ModNPC
	{
		/* ai[0] = follower
		 * ai[1] = following
