...
namespace AerovelenceMod.Content.Tiles.CrystalCaverns.Natural
{
    public class CavernStone : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            TileID.Sets.GeneralPlacementTiles[ModContent.TileType<CavernStone>()] = false;
            TileID.Sets.CanBeClearedDuringGeneration[ModContent.TileType<CavernStone>()] = false;
    ...
    public class CavernStoneItem : ModItem
    {
        public override void SetDefaults()
        {
            ...
            Item.createTile = ModContent.TileType<CavernStone>();
