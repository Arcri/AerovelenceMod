...
{
    public abstract class CavernStone1x1CeilingRubbleBase : ModTile
    {
        public override string Texture => "AerovelenceMod/Content/Tiles/CrystalCaverns/Rubble/CavernStone1x1CeilingRubble";
    ...
    // Rubblemaker version
    public class CavernStone1x1CeilingRubbleFake : CavernStone1x1CeilingRubbleBase
    {
        public override void SetStaticDefaults()
        {
    ...
    // Generated version
    public class CavernStone1x1CeilingRubbleNatural : CavernStone1x1CeilingRubbleBase
    {
        public override void SetStaticDefaults()
        {
            base.SetStaticDefaults();
