...
namespace AerovelenceMod.Content.Tiles.CrystalCaverns.Tiles.Furniture
{
	public class GlimmeringChest : ModTile
	{
		public override void SetStaticDefaults()
		{
			...
			//ChestDrop = ModContent.ItemType<GlimmeringChest>();

			// Names
			ContainerName.SetDefault("Glimmering Chest");
			...
			name.SetDefault("Locked Glimmering Chest");
		...
		public override void MouseOver(int i, int j)
		{
			...
			{
				player.cursorItemIconText = Main.chest[chest].name.Length > 0 ? Main.chest[chest].name : "Glimmering Chest";
				if (player.cursorItemIconText == "Glimmering Chest")
				{
					player.cursorItemIconID = ModContent.ItemType<CavernChestItem>();
