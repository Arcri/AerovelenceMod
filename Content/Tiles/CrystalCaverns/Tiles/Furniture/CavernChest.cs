...
namespace AerovelenceMod.Content.Tiles.CrystalCaverns.Tiles.Furniture
{
	public class CavernChest : ModTile
	{
		public override void SetStaticDefaults()
		{
			...
			// Names
			ContainerName.SetDefault("Cavern Chest");
			...
			name.SetDefault("Locked Cavern Chest");
		...
		public override void MouseOver(int i, int j)
		{
			...
			{
				player.cursorItemIconText = Main.chest[chest].name.Length > 0 ? Main.chest[chest].name : "Cavern Chest";
				if (player.cursorItemIconText == "Cavern Chest")
				{
