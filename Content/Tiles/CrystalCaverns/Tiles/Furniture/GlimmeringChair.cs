...
{
    public class GlimmeringChair : ModTile
	{
		...
		{
            Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 16, 32, ItemType<Items.Placeables.Furniture.Glimmering.GlimmeringChair>());
		}
	}
}