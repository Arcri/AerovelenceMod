...
namespace AerovelenceMod.Blocks.Void.Tiles.Flora
{
	public class VoidVines : ModTile
	{
		...
		public override bool TileFrame(int i, int j, ref bool resetFrame, ref bool noBreak)
		{
			...
			if (type == ModContent.TileType<VoidGrass>() || type == Type)
			{
				return true;
			}
		...
		public override void RandomUpdate(int i, int j)
		{
			...
			if (WorldGen.genRand.NextBool(15) && !tileBelow.active() && !tileBelow.lava())
			{
				...
				while (yTest > j - 10)
				{
					...
					else if (!testTile.active() || testTile.type != ModContent.TileType<VoidGrass>())
					{
						yTest--;
						continue;
					}
