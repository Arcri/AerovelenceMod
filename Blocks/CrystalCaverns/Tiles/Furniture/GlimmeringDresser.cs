...
namespace AerovelenceMod.Blocks.CrystalCaverns.Tiles.Furniture
{
	public class GlimmeringDresser : ModTile
	{
		public override void SetDefaults()
		{
			...
			dresserDrop = ItemType<Items.Placeable.CrystalCaverns.GlimmeringDresserItem>();
		}
		...
		public override void MouseOverFar(int i, int j)
		{
			...
			else
			{
				...
				{
					player.showItemIcon2 = ItemType<AerovelenceMod.Items.Placeable.CrystalCaverns.GlimmeringDresserItem>();
